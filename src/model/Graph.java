 ...
 * Knotenobjekt zu einem bestimmten Inhalt gehoert und ob der Graph leer ist.
 * </p>
 *
...
public class Graph<ContentType>{
    ...
    /**
     * Die Anfrage liefert das Knotenobjekt mit pContent als Inhalt. Ist ein solches Knotenobjekt nicht im Graphen enthalten,
    ...
    public Vertex<ContentType> getVertex(ContentType pContent){
        ...
        if(pContent != null){
            vertices.toFirst();
            while(vertices.hasAccess()){
                if(vertices.getContent().getContent() == pContent){
     ...
     * Knoten mit demselben Inhalt wie pVertex im Graphen gibt und pVertex einen Inhalt ungleich null hat.
     * Ansonsten passiert nichts.
     */
    public void addVertex(Vertex pVertex){

        if(pVertex != null && pVertex.getContent() != null && getVertex((ContentType) pVertex.getContent()) == null){
    ...
    public void addEdge(Edge pEdge){
        ...
        if (pEdge != null){
            ...
            if (vertexPair[0] != null && vertexPair[1] != null &&
                    this.getVertex((ContentType)vertexPair[0].getContent()) == vertexPair[0] &&
                    this.getVertex((ContentType)vertexPair[1].getContent()) == vertexPair[1] &&
